...
To integerate AZStack SDK to your application, you need to create an AZStack account. If you do not have an AZStack account, sign up here(link)
...
You should start authentication process after AZStack SDK connectes successfully.
...
```
using RSA publicKey generated in step 1. You can refer to the following sample code :
```
<?php

    //Hardcode in your server

    $pubkeystr = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAvpOXlvyuZnrMJyWVgfsm 

fqEkdGtWwJ70WgaDd41EQxtR9UiRTLxq9pf2ogKg93ayBzgN8Nld3LHeyoeTMzhW 

k2WDIPnkoECQL3Cl1rmzFXgo1lsK+tGQHKSZnWLr2vSaE+BJbzrrjY0yqathMjeD 

LZqmcfc8LWNOM1cQi5rBImqIuEDPFZGpjDQGOsB+caDdyEbpJc/oq+dlNDm5Y59S 

+qCbB+IvW1xT2QA2FjO5FQ6TRmRNd25nYhZJqRnP9/kP4f1sLLgSlxsKgNziz1I9 

k2PJGbK1tGnLauPlLX7C0vs7tWs3Ve7KamjXURvDWfrtfMHg2Gg6r948fHCBbeAK dQIDAQAB";
    ...
    $pass = $_GET["pass"];//using to authentication with username
    ...
    //check username / pass in your backend
    ...
    */
    ...
    //username / pass is correct, return identity token, AzStack client continue 
